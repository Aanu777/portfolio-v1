...
export function GithubCalendar({
    ...
    return (
        <div className={cn("flex w-max min-w-full max-w-none flex-col gap-4", className)}>
            {showTotal && (
            ...
            <div
                className="relative flex w-max max-w-none flex-nowrap gap-[3px]"
                onMouseLeave={() => {
                    setHoveredDate(null)
            ...
            >
                ...
                {weeks.map((week, weekIndex) => (
                    <div key={weekIndex} className="flex w-[11px] flex-col gap-[3px] sm:w-[14px]">
